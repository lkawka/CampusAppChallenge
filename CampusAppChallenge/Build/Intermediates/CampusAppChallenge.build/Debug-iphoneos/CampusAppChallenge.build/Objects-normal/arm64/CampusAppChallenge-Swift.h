...
SWIFT_MODULE_NAMESPACE_PUSH("CampusAppChallenge")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC18CampusAppChallenge11AppDelegate")
...
SWIFT_CLASS("_TtC18CampusAppChallenge14FindPeopleView")
@interface FindPeopleView : UITableView
